...
export interface DoubleValueProtoMsg {
  typeUrl: "/greenfield.common.DoubleValue";
  value: Uint8Array;
}
/**
 * Wrapper message for `double`.
...
export interface Int64ValueProtoMsg {
  typeUrl: "/greenfield.common.Int64Value";
  value: Uint8Array;
}
/**
 * Wrapper message for `int64`.
...
export interface Int32ValueProtoMsg {
  typeUrl: "/greenfield.common.Int32Value";
  value: Uint8Array;
}
/**
 * Wrapper message for `int32`.
...
export interface BoolValueProtoMsg {
  typeUrl: "/greenfield.common.BoolValue";
  value: Uint8Array;
}
/**
 * Wrapper message for `bool`.
...
export interface StringValueProtoMsg {
  typeUrl: "/greenfield.common.StringValue";
  value: Uint8Array;
}
/**
 * Wrapper message for `string`.
