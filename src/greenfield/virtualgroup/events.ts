...
export const EventCreateGlobalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventCreateGlobalVirtualGroup",
  encode(message: EventCreateGlobalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCreateGlobalVirtualGroup {
...
export const EventUpdateGlobalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventUpdateGlobalVirtualGroup",
  encode(message: EventUpdateGlobalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.storeSize !== BigInt(0)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventUpdateGlobalVirtualGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): EventUpdateGlobalVirtualGroup {
    return {
      id: isSet(object.id) ? Number(object.id) : 0,
      storeSize: isSet(object.storeSize) ? BigInt(object.storeSize.toString()) : BigInt(0),
      totalDeposit: isSet(object.totalDeposit) ? String(object.totalDeposit) : "",
      primarySpId: isSet(object.primarySpId) ? Number(object.primarySpId) : 0,
      secondarySpIds: Array.isArray(object?.secondarySpIds) ? object.secondarySpIds.map((e: any) => Number(e)) : []
    };
  ...
  toJSON(message: EventUpdateGlobalVirtualGroup): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = Math.round(message.id));
    message.storeSize !== undefined && (obj.storeSize = (message.storeSize || BigInt(0)).toString());
    message.totalDeposit !== undefined && (obj.totalDeposit = message.totalDeposit);
    message.primarySpId !== undefined && (obj.primarySpId = Math.round(message.primarySpId));
    if (message.secondarySpIds) {
      obj.secondarySpIds = message.secondarySpIds.map(e => Math.round(e));
  ...
  fromPartial<I extends Exact<DeepPartial<EventUpdateGlobalVirtualGroup>, I>>(object: I): EventUpdateGlobalVirtualGroup {
    const message = createBaseEventUpdateGlobalVirtualGroup();
    message.id = object.id ?? 0;
    message.storeSize = object.storeSize !== undefined && object.storeSize !== null ? BigInt(object.storeSize.toString()) : BigInt(0);
    message.totalDeposit = object.totalDeposit ?? "";
    message.primarySpId = object.primarySpId ?? 0;
    message.secondarySpIds = object.secondarySpIds?.map(e => e) || [];
    return message;
  ...
  fromAmino(object: EventUpdateGlobalVirtualGroupAmino): EventUpdateGlobalVirtualGroup {
    ...
    if (object.store_size !== undefined && object.store_size !== null) {
      message.storeSize = BigInt(object.store_size);
    }
    if (object.total_deposit !== undefined && object.total_deposit !== null) {
      message.totalDeposit = object.total_deposit;
    }
...
export const EventDeleteGlobalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventDeleteGlobalVirtualGroup",
  encode(message: EventDeleteGlobalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.primarySpId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventDeleteGlobalVirtualGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventCreateGlobalVirtualGroupFamily = {
  typeUrl: "/greenfield.virtualgroup.EventCreateGlobalVirtualGroupFamily",
  encode(message: EventCreateGlobalVirtualGroupFamily, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.primarySpId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCreateGlobalVirtualGroupFamily {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventUpdateGlobalVirtualGroupFamily = {
  typeUrl: "/greenfield.virtualgroup.EventUpdateGlobalVirtualGroupFamily",
  encode(message: EventUpdateGlobalVirtualGroupFamily, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.primarySpId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventUpdateGlobalVirtualGroupFamily {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventDeleteGlobalVirtualGroupFamily = {
  typeUrl: "/greenfield.virtualgroup.EventDeleteGlobalVirtualGroupFamily",
  encode(message: EventDeleteGlobalVirtualGroupFamily, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.primarySpId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventDeleteGlobalVirtualGroupFamily {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventCreateLocalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventCreateLocalVirtualGroup",
  encode(message: EventCreateLocalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.bucketId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCreateLocalVirtualGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventUpdateLocalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventUpdateLocalVirtualGroup",
  encode(message: EventUpdateLocalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.bucketId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventUpdateLocalVirtualGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventDeleteLocalVirtualGroup = {
  typeUrl: "/greenfield.virtualgroup.EventDeleteLocalVirtualGroup",
  encode(message: EventDeleteLocalVirtualGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.bucketId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventDeleteLocalVirtualGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventSwapOut = {
  typeUrl: "/greenfield.virtualgroup.EventSwapOut",
  encode(message: EventSwapOut, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventSwapOut {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventCompleteSwapOut = {
  typeUrl: "/greenfield.virtualgroup.EventCompleteSwapOut",
  encode(message: EventCompleteSwapOut, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.storageProviderId !== 0) {
      writer.uint32(8).uint32(message.storageProviderId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCompleteSwapOut {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventCancelSwapOut = {
  typeUrl: "/greenfield.virtualgroup.EventCancelSwapOut",
  encode(message: EventCancelSwapOut, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.storageProviderId !== 0) {
      writer.uint32(8).uint32(message.storageProviderId);
    }
    if (message.globalVirtualGroupFamilyId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCancelSwapOut {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventStorageProviderExit = {
  typeUrl: "/greenfield.virtualgroup.EventStorageProviderExit",
  encode(message: EventStorageProviderExit, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.storageProviderId !== 0) {
      writer.uint32(8).uint32(message.storageProviderId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventStorageProviderExit {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventCompleteStorageProviderExit = {
  typeUrl: "/greenfield.virtualgroup.EventCompleteStorageProviderExit",
  encode(message: EventCompleteStorageProviderExit, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.storageProviderId !== 0) {
      writer.uint32(8).uint32(message.storageProviderId);
    }
    if (message.operatorAddress !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCompleteStorageProviderExit {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
