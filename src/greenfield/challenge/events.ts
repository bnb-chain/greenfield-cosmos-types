...
export const EventStartChallenge = {
  typeUrl: "/greenfield.challenge.EventStartChallenge",
  encode(message: EventStartChallenge, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventStartChallenge {
...
export const EventAttestChallenge = {
  typeUrl: "/greenfield.challenge.EventAttestChallenge",
  encode(message: EventAttestChallenge, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.challengeId !== BigInt(0)) {
      writer.uint32(8).uint64(message.challengeId);
    }
    if (message.result !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventAttestChallenge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
