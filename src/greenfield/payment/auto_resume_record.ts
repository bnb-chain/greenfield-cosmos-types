...
export const AutoResumeRecord = {
  typeUrl: "/greenfield.payment.AutoResumeRecord",
  encode(message: AutoResumeRecord, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AutoResumeRecord {
