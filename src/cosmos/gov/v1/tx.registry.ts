...
export const MessageComposer = {
  encoded: {
    ...
    updateCrossChainParams(value: MsgUpdateCrossChainParams) {
      return {
        typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
        value: MsgUpdateCrossChainParams.encode(value).finish()
      };
    }
  },
  withTypeUrl: {
  ...
  toJSON: {
    ...
    updateCrossChainParams(value: MsgUpdateCrossChainParams) {
      return {
        typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
        value: MsgUpdateCrossChainParams.toJSON(value)
      };
    }
  },
  fromJSON: {
    ...
    updateCrossChainParams(value: any) {
      return {
        typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
        value: MsgUpdateCrossChainParams.fromJSON(value)
      };
    }
  },
  fromPartial: {
    ...
    updateCrossChainParams(value: MsgUpdateCrossChainParams) {
      return {
        typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
        value: MsgUpdateCrossChainParams.fromPartial(value)
      };
    }
  }
};