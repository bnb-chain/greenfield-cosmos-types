...
export const MsgUpdateCrossChainParams = {
  typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
  encode(message: MsgUpdateCrossChainParams, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.params !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateCrossChainParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromAmino(object: MsgUpdateCrossChainParamsAmino): MsgUpdateCrossChainParams {
    ...
    if (object.params !== undefined && object.params !== null) {
      message.params = CrossChainParamsChange.fromAmino(object.params);
    }
  ...
  toAmino(message: MsgUpdateCrossChainParams): MsgUpdateCrossChainParamsAmino {
    const obj: any = {};
    obj.authority = message.authority;
    obj.params = message.params ? CrossChainParamsChange.toAmino(message.params) : CrossChainParamsChange.fromPartial({});
    obj.dest_chain_id = message.destChainId;
    return obj;
  },
  fromAminoMsg(object: MsgUpdateCrossChainParamsAminoMsg): MsgUpdateCrossChainParams {
    return MsgUpdateCrossChainParams.fromAmino(object.value);
  },
  toAminoMsg(message: MsgUpdateCrossChainParams): MsgUpdateCrossChainParamsAminoMsg {
    return {
      ...
      value: MsgUpdateCrossChainParams.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgUpdateCrossChainParamsProtoMsg): MsgUpdateCrossChainParams {
    return MsgUpdateCrossChainParams.decode(message.value);
  },
  toProto(message: MsgUpdateCrossChainParams): Uint8Array {
    return MsgUpdateCrossChainParams.encode(message).finish();
  },
  toProtoMsg(message: MsgUpdateCrossChainParams): MsgUpdateCrossChainParamsProtoMsg {
    return {
      typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParams",
      value: MsgUpdateCrossChainParams.encode(message).finish()
    };
  }
};
function createBaseMsgUpdateCrossChainParamsResponse(): MsgUpdateCrossChainParamsResponse {
  return {};
}
export const MsgUpdateCrossChainParamsResponse = {
  typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParamsResponse",
  encode(_: MsgUpdateCrossChainParamsResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateCrossChainParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateCrossChainParamsResponse>, I>>(_: I): MsgUpdateCrossChainParamsResponse {
    const message = createBaseMsgUpdateCrossChainParamsResponse();
    return message;
  },
  ...
  fromAminoMsg(object: MsgUpdateCrossChainParamsResponseAminoMsg): MsgUpdateCrossChainParamsResponse {
    return MsgUpdateCrossChainParamsResponse.fromAmino(object.value);
  },
  toAminoMsg(message: MsgUpdateCrossChainParamsResponse): MsgUpdateCrossChainParamsResponseAminoMsg {
    return {
      ...
      value: MsgUpdateCrossChainParamsResponse.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgUpdateCrossChainParamsResponseProtoMsg): MsgUpdateCrossChainParamsResponse {
    return MsgUpdateCrossChainParamsResponse.decode(message.value);
  },
  toProto(message: MsgUpdateCrossChainParamsResponse): Uint8Array {
    return MsgUpdateCrossChainParamsResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgUpdateCrossChainParamsResponse): MsgUpdateCrossChainParamsResponseProtoMsg {
    return {
      typeUrl: "/cosmos.gov.v1.MsgUpdateCrossChainParamsResponse",
      value: MsgUpdateCrossChainParamsResponse.encode(message).finish()
    };
  }
};
export const Cosmos_govv1beta1Content_InterfaceDecoder = (input: BinaryReader | Uint8Array): CommunityPoolSpendProposal | CommunityPoolSpendProposalWithDeposit | TextProposal | ParameterChangeProposal | Any => {
  const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
...
export class MsgClientImpl implements Msg {
  ...
  UpdateCrossChainParams(request: MsgUpdateCrossChainParams): Promise<MsgUpdateCrossChainParamsResponse> {
    const data = MsgUpdateCrossChainParams.encode(request).finish();
    const promise = this.rpc.request("cosmos.gov.v1.Msg", "UpdateCrossChainParams", data);
    return promise.then(data => MsgUpdateCrossChainParamsResponse.decode(new BinaryReader(data)));
  }
}