...
export interface CrossChainParamsChangeProtoMsg {
  typeUrl: "/cosmos.gov.v1.CrossChainParamsChange";
  value: Uint8Array;
}
/** CrossChainParamsChange defines the parameter change or contract upgrade */
...
export const CrossChainParamsChange = {
  typeUrl: "/cosmos.gov.v1.CrossChainParamsChange",
  encode(message: CrossChainParamsChange, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CrossChainParamsChange {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromAmino(object: CrossChainParamsChangeAmino): CrossChainParamsChange {
    const message = createBaseCrossChainParamsChange();
  ...
  toAmino(message: CrossChainParamsChange): CrossChainParamsChangeAmino {
    const obj: any = {};
    obj.key = message.key;
    if (message.values) {
      obj.values = message.values.map(e => e);
  ...
  fromAminoMsg(object: CrossChainParamsChangeAminoMsg): CrossChainParamsChange {
    return CrossChainParamsChange.fromAmino(object.value);
  },
  toAminoMsg(message: CrossChainParamsChange): CrossChainParamsChangeAminoMsg {
    return {
      type: "cosmos-sdk/v1/CrossChainParamsChange",
      value: CrossChainParamsChange.toAmino(message)
    };
  },
  fromProtoMsg(message: CrossChainParamsChangeProtoMsg): CrossChainParamsChange {
    return CrossChainParamsChange.decode(message.value);
  },
  toProto(message: CrossChainParamsChange): Uint8Array {
    return CrossChainParamsChange.encode(message).finish();
  },
  toProtoMsg(message: CrossChainParamsChange): CrossChainParamsChangeProtoMsg {
    return {
      typeUrl: "/cosmos.gov.v1.CrossChainParamsChange",
      value: CrossChainParamsChange.encode(message).finish()
    };
  }
};