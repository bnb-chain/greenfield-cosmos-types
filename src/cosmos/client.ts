...
import * as cosmosCrosschainV1TxRegistry from "./crosschain/v1/tx.registry";
...
import * as cosmosGashubV1beta1TxRegistry from "./gashub/v1beta1/tx.registry";
...
import * as cosmosOracleV1TxRegistry from "./oracle/v1/tx.registry";
...
import * as cosmosCrosschainV1TxAmino from "./crosschain/v1/tx.amino";
...
import * as cosmosGashubV1beta1TxAmino from "./gashub/v1beta1/tx.amino";
...
import * as cosmosOracleV1TxAmino from "./oracle/v1/tx.amino";
...
export const cosmosAminoConverters = {
  ...
  ...cosmosCrosschainV1TxAmino.AminoConverter,
  ...
  ...cosmosGashubV1beta1TxAmino.AminoConverter,
  ...
  ...cosmosOracleV1TxAmino.AminoConverter,
...
export const cosmosProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...cosmosAuthV1beta1TxRegistry.registry, ...cosmosAuthzV1beta1TxRegistry.registry, ...cosmosBankV1beta1TxRegistry.registry, ...cosmosConsensusV1TxRegistry.registry, ...cosmosCrisisV1beta1TxRegistry.registry, ...cosmosCrosschainV1TxRegistry.registry, ...cosmosDistributionV1beta1TxRegistry.registry, ...cosmosEvidenceV1beta1TxRegistry.registry, ...cosmosFeegrantV1beta1TxRegistry.registry, ...cosmosGashubV1beta1TxRegistry.registry, ...cosmosGovV1TxRegistry.registry, ...cosmosGovV1beta1TxRegistry.registry, ...cosmosGroupV1TxRegistry.registry, ...cosmosMintV1beta1TxRegistry.registry, ...cosmosNftV1beta1TxRegistry.registry, ...cosmosOracleV1TxRegistry.registry, ...cosmosSlashingV1beta1TxRegistry.registry, ...cosmosStakingV1beta1TxRegistry.registry, ...cosmosVestingV1beta1TxRegistry.registry];
