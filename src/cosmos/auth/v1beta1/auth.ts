...
function createBaseParams(): Params {
  return {
    ...
    sig_verify_cost_ethsecp256k1: Long.UZERO
  };
}
...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (!message.sig_verify_cost_ethsecp256k1.isZero()) {
      writer.uint32(48).uint64(message.sig_verify_cost_ethsecp256k1);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Params {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.sig_verify_cost_ethsecp256k1 = (reader.uint64() as Long);
          break;
  ...
  fromJSON(object: any): Params {
    return {
      ...
      sig_verify_cost_ethsecp256k1: isSet(object.sig_verify_cost_ethsecp256k1) ? Long.fromValue(object.sig_verify_cost_ethsecp256k1) : Long.UZERO
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.sig_verify_cost_ethsecp256k1 !== undefined && (obj.sig_verify_cost_ethsecp256k1 = (message.sig_verify_cost_ethsecp256k1 || Long.UZERO).toString());
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.sig_verify_cost_ethsecp256k1 = object.sig_verify_cost_ethsecp256k1 !== undefined && object.sig_verify_cost_ethsecp256k1 !== null ? Long.fromValue(object.sig_verify_cost_ethsecp256k1) : Long.UZERO;
    return message;
  }
